...
;		Modified by MBKane to include height, width, and aspect ratio
; ======================================================================================================================
   ...
   If DllCall("User32.dll\GetMonitorInfo", "Ptr", HMON, "Ptr", &MIEX) {
      ...
      Return {Name:      (Name := StrGet(&MIEX + 40, 32))
            ...
            , Bottom:    NumGet(MIEX, 16, "Int")   ; "
						, Width:     NumGet(MIEX, 12, "Int") - NumGet(MIEX, 4, "Int") ; "
						, Height:    NumGet(MIEX, 16, "Int") - NumGet(MIEX, 8, "Int")
						, AR:        (NumGet(MIEX, 12, "Int") - NumGet(MIEX, 4, "Int")) / (NumGet(MIEX, 16, "Int") - NumGet(MIEX, 8, "Int")) ; " aspect ratio
            , WALeft:    NumGet(MIEX, 20, "Int")   ; work area
            , WATop:     NumGet(MIEX, 24, "Int")   ; "
            , WARight:   NumGet(MIEX, 28, "Int")   ; "
            , WABottom:  NumGet(MIEX, 32, "Int")   ; "
						, WAWidth:   NumGet(MIEX, 28, "Int") - NumGet(MIEX, 20, "Int") ; "
						, WAHeight:  NumGet(MIEX, 32, "Int") - NumGet(MIEX, 24, "Int")
						, WAAR:      (NumGet(MIEX, 28, "Int") - NumGet(MIEX, 20, "Int")) / (NumGet(MIEX, 32, "Int") - NumGet(MIEX, 24, "Int")) ; " aspect ratio
