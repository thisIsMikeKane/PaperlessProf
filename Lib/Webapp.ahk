...
; Add files at compile time
FileCreateDir, assets ; Create the directory if running from compiled script
; TODO do some error checking
FileInstall assets\index.html, assets\index.html
FileInstall assets\w3.css, assets\w3.css
FileInstall assets\gui.css, assets\gui.css
FileInstall assets\btn_hide.png, assets\btn_hide.png
FileInstall assets\btn_show.png, assets\btn_show.png
FileInstall assets\webapp.json, assets\webapp.json

__Webapp_jsonf := "assets/webapp.json"
...
try {
	...
	__Webapp_html_url := __Webapp_DefaultVar(j.html_url,"assets/index.html")
...
Gui __Webapp_:+LastFound -Resize -MaximizeBox +AlwaysOnTop +Hwnd__Webapp_GuiHwnd
...
__Webapp_GuiClose:
	...
	__Webapp_protocol_call.call("close") ; Send a close call back
	ExitApp
return
...
; Get full path 
;  https://autohotkey.com/board/topic/40135-absolutepath-derives-an-absolute-path-from-a-relative-path/
getFileFullPath(Path = "", Base = "") {
